...
topic \topic{mqttping}. Senzor \HAentity{sensor.last\_mqtt\_ping} zachycuje
zprávy na tomto topicu a jeho stav je shodný s payloadem přijaté zprávy.
Senzor \HAentity{binary\_sensor.mqtt\_broker} každou minutu ověřuje, jestli je
stav senzoru \HAentity{sensor.last\_mqtt\_ping} parsovaný jako čas déle starší
...
\HAentity{binary\_sensor.mqtt\_broker} \HAstate{off} déle než \SI{10}{\second},
