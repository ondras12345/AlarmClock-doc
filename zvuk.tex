...
100%|###################| 48/48 [00:03<00:00, 12.56it/s]
$ ls -l hlavicky.bin
-rw-r--r-- 1 ondra ondra 48 2022-01-07 08:18 hlavicky.bin
$ xxd hlavicky.bin
00000000: 0178 0101 fe05 3700 1e02 03ff 0101 fe05  .x....7.........
00000010: 0a00 2002 03ff 0101 fe08 1e00 c002 03ff  .. .............
00000020: 0101 fe04 3200 1002 03ff 0101 fe07 1e00  ....2...........
$
\end{lstlisting}
...
+ (poke) melody_headers
[EEPROM_melody_header {(uint<6>) 0,enabled=(uint<1>) 0,valid=(uint<1>) 1,data_address=376UH},EEPROM_melody_header {(uint<6>) 0,enabled=(uint<1>) 0,valid=(uint<1>) 1,data_address=1534UH},EEPROM_melody_header {(uint<6>) 13,enabled=(uint<1>) 1,valid=(uint<1>) 1,data_address=7680UH}]
...
struktur, které volá metody \verb|_print| daných struktur.
% TODO headers.bin obsahuje odpad, protoze jsem ho precetl z produkcniho budiku misto testovaciho
